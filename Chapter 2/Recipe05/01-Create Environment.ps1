...
Add-DnsServerPrimaryZone -Name 'recipe0205.demo' -ZoneFile 'contoso.dns'
# Add an A record to the zone
Add-DnsServerResourceRecordA -Name 'samplerecord' -ZoneName $zoneName -IPv4Address 10.0.0.200
